...
int main() {
  ...
  benchmark_execution_speed([&] {
    for (auto i = 0; i < 1'000'000; ++i) {
      if (rand() % 1) sm.handle(e1());
      if (rand() % 2) sm.handle(e2());
      if (rand() % 3) sm.handle(e3());
      if (rand() % 4) sm.handle(e4());
      if (rand() % 5) sm.handle(e5());
      if (rand() % 6) sm.handle(e6());
      if (rand() % 7) sm.handle(e7());
      if (rand() % 8) sm.handle(e8());
      if (rand() % 9) sm.handle(e9());
      if (rand() % 10) sm.handle(e10());
      if (rand() % 11) sm.handle(e11());
      if (rand() % 12) sm.handle(e12());
      if (rand() % 13) sm.handle(e13());
      if (rand() % 14) sm.handle(e14());
      if (rand() % 15) sm.handle(e15());
      if (rand() % 16) sm.handle(e16());
      if (rand() % 17) sm.handle(e17());
      if (rand() % 18) sm.handle(e18());
      if (rand() % 19) sm.handle(e19());
      if (rand() % 20) sm.handle(e20());
      if (rand() % 21) sm.handle(e21());
      if (rand() % 22) sm.handle(e22());
      if (rand() % 23) sm.handle(e23());
      if (rand() % 24) sm.handle(e24());
      if (rand() % 25) sm.handle(e25());
      if (rand() % 26) sm.handle(e26());
      if (rand() % 27) sm.handle(e27());
      if (rand() % 28) sm.handle(e28());
      if (rand() % 29) sm.handle(e29());
      if (rand() % 30) sm.handle(e30());
      if (rand() % 31) sm.handle(e31());
      if (rand() % 32) sm.handle(e32());
      if (rand() % 33) sm.handle(e33());
      if (rand() % 34) sm.handle(e34());
      if (rand() % 35) sm.handle(e35());
      if (rand() % 36) sm.handle(e36());
      if (rand() % 37) sm.handle(e37());
      if (rand() % 38) sm.handle(e38());
      if (rand() % 39) sm.handle(e39());
      if (rand() % 40) sm.handle(e40());
      if (rand() % 41) sm.handle(e41());
      if (rand() % 42) sm.handle(e42());
      if (rand() % 43) sm.handle(e43());
      if (rand() % 44) sm.handle(e44());
      if (rand() % 45) sm.handle(e45());
      if (rand() % 46) sm.handle(e46());
      if (rand() % 47) sm.handle(e47());
      if (rand() % 48) sm.handle(e48());
      if (rand() % 49) sm.handle(e49());
      if (rand() % 50) sm.handle(e50());
    }
  });
