...
struct player_ : msm::front::state_machine_def<player_, base_state> {
  ...
  // clang format-off
  EUML2_STT(player_, EUML2_STT_CFG(EUML2_STT_USE("Playing", Playing)), EUML2_ROW("Stopped + play / start_playback -> Playing"),
            EUML2_ROW("Pause + end_pause / resume_playback -> Playing"), EUML2_ROW("Open + open_close / close_drawer -> Empty"),
            EUML2_ROW("Empty + open_close / open_drawer -> Open"), EUML2_ROW("Pause + open_close / stop_and_open -> Open"),
            EUML2_ROW("Stopped + open_close / open_drawer -> Open"), EUML2_ROW("Playing + open_close / stop_and_open -> Open"),
            EUML2_ROW("Playing + pause / pause_playback -> Pause"), EUML2_ROW("Playing + stop / stop_playback -> Stopped"),
